...
export default async function handler(req, res) {
  ...
  /* Must be an address on a VERIFIED Resend domain. onboarding@resend.dev is
     Resend's sandbox sender and only delivers to your own account email —
     using it for real recipients returns 403 Forbidden. */
