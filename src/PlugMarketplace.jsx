      ...
      {isHero && (
        <div style={{ position:"relative", height:480, overflow:"hidden" }}>
          <video
              ...
              <source src="https://assets.mixkit.co/videos/preview/mixkit-friends-toasting-at-a-party-4638-large.mp4" type="video/mp4" />
              <source src="https://assets.mixkit.co/videos/preview/mixkit-people-celebrating-at-a-party-4642-large.mp4" type="video/mp4" />
              <img src={market?.hero || "https://images.unsplash.com/photo-1519671482749-fd09be7ccebf?w=1600&q=80"}
                alt="Event" style={{ width:"100%", height:"100%", objectFit:"cover" }} />
            </video>
